...
| FR-022 | DQ-06–DQ-08 | EVD-019、EVD-023、EVD-025 | [Codex Skills](../technical/codex-skills.md)、[API 与 MCP](../technical/api-and-mcp-contracts.md) | ADR-001（ACCEPTED）、ADR-002（ACCEPTED）、ADR-003（DRAFT） | schema、来源、人工评审、权限不提升和无副作用 E2E | G2/G3 | ACCEPTED |
