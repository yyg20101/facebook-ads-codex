/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/control-plane-worker/wrangler.jsonc services/control-plane-worker/worker-configuration.d.ts` (hash: e5c424cbb7903094de8db8a0ffbdf27b)
// Runtime types generated with workerd@1.20260801.1 2026-08-05 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	OFFLINE_FIXTURES_ENABLED: "true";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OFFLINE_FIXTURES_ENABLED">> {}
}
